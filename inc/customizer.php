...
function craigfern_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize,
			'header_color', array(
				'label' => __( 'Header Background Color', 'craigfern' ),
				'section' => 'colors',
			)
		)
	);
	...
	$wp_customize->add_section( 'craigfern-options', array(
		'title' => __( 'Theme Options', 'craigfern' ),
		'capability' => 'edit_theme_options',
		'description' => __( 'Change the default display options for the theme.', 'craigfern' ),
	));
	...
	$wp_customize->add_setting(	'layout_setting',
		array(
			'default' => 'no-sidebar',
			'type' => 'theme_mod',
			'sanitize_callback' => 'craigfern_sanitize_layout', 
			'transport' => 'postMessage'
		)
	);
	...
	$wp_customize->add_control(	'layout_control',
		array(
			...
			'type' => 'radio',
			'label' => __( 'Sidebar position', 'craigfern' ),
			'choices' => array(
				'no-sidebar' => __( 'No sidebar (default)', 'craigfern' ),
				'sidebar-left' => __( 'Left sidebar', 'craigfern' ),
				'sidebar-right' => __( 'Right sidebar', 'craigfern' )
			),
			'section' => 'craigfern-options',
		)
	);
}
 ...
 */
function craigfern_sanitize_layout( $value ) {
 ...
 */
function craigfern_customizer_css() {
...
add_action( 'wp_head', 'craigfern_customizer_css' );
